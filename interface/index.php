        ...
        <div class="d-flex justify-content-center align-items-center mt-5">
                <form class="w-25" action="index.php" method="POST">
                        <div class="mb-3">
                            ...
                            <?php 
                                if(isset($invalidUsername)){
                                    echo "<div class='text-danger'>".$invalidUsername."</div>";
                                }
                            ?>
                        </div>
                        <div class="mb-3">
                            ...
                            <?php 
                                if(isset($invalidEmail)){
                                    echo "<div class='text-danger'>".$invalidEmail."</div>";
                                }
                            ?>
                        </div>
                        <div class="mb-3">
                            ...
                            <?php 
                                if(isset($invalidGender)){
                                    echo "<div class='text-danger'>".$invalidGender."</div>";
                                }
                            ?>
                        </div>
                        <div class="mb-3"> 
                            ...
                            <?php 
                                if(isset($invalidClass)){
                                    echo "<div class='text-danger'>".$invalidClass."</div>";
                                }
                            ?>
                        </div>
                        <div class="mb-3">
